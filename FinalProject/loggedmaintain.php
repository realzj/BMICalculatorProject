...
This is 3 out of 3 of the same code used but in all 3 codes the images headers and paragragh change in order to fit the objective of this project
...
<body>
    ...
    <div class="menu">
        <div class="food-items">
            <img src="images/maintain_breakfast.jpg">
            <div class="details">
        ...
        <div class="food-items">
            <img src="images/maintain_snack.jpg">
            <div class="details">
                <div class="details-sub">
        ...
        <div class="food-items">
            <img src="images/maintain_lunch.jpg">
            <div class="details">
                <div class="details-sub">
        ...
        <div class="food-items">
            <img src="images/maintain_snack2.jpg">
            <div class="details">
                <div class="details-sub">
        ...
        <div class="food-items">
            <img src="images/maintain_dinner.jpg">
            <div class="details">
                <div class="details-sub">
                    <h5>Baked salmon with roasted vegetables</h5>
                    <h5 class="calories"> (Approx. 400 calories) </h5>
                </div>
                <p> oz of baked salmon (240 calories)<br>
